...
export default function CreateAddress() {
    ...
    const addAddress = () => {
        ...
        axios.post(`${process.env.REACT_APP_BACKEND_URL}/addresses`, inputs, {
            headers: {
            ...
            <Layout>
                <Container maxWidth="sm">
                    ...
                    <form >
                        ...
                        <Box display="flex" justifyContent="flex-end" >
                            <Button variant="contained" color="primary" size="small" type="button" onClick={addAddress}>Save</Button>
                        </Box>
                    </form>
                </Container>
            </Layout>
